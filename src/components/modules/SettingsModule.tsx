  ...
  const sections = [
    {
      ...
      icon: Settings,
      title: "General",
      description: "Language, startup, updates",
    },
    {
      id: "notifications",
      icon: Bell,
    ...
    },
    {
      ...
      icon: RefreshCw,
      title: "Scan Settings",
      description: "Schedule, what to scan",
    },
    {
      id: "about",
      icon: Info,
              ...
              >
                ...
                <div>
                  <p
                    className={cn(
                      "font-medium",
                      activeSection === section.id ? "text-text-primary" : "",
                    )}
                  >
                    {section.title}
                  </p>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-bg-tertiary rounded-lg">
                  ...
                  <Switch
                    checked={generalSettings.startWithWindows}
                    ...
                    <div className="flex items-center justify-between p-4 bg-bg-tertiary rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-text-secondary">
                            Notify when optimization finishes
                          </p>
                        </div>
                      </div>
                      <Switch
                        checked={notificationSettings.optimizationComplete}
                        onCheckedChange={(checked) =>
                          setNotificationSettings({
                            ...notificationSettings,
                            optimizationComplete: checked,
                          })
                        }
                      />
                    </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-bg-tertiary rounded-lg">
                  ...
                  <Switch
                    checked={privacySettings.autoCleanBrowsingData}
                    onCheckedChange={(checked) =>
                      setPrivacySettings({
                        ...privacySettings,
                        autoCleanBrowsingData: checked,
                      })
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-bg-tertiary rounded-lg">
                  ...
                  <Switch
                    checked={privacySettings.passwordProtectSettings}
                    onCheckedChange={(checked) =>
                      setPrivacySettings({
                        ...privacySettings,
                        passwordProtectSettings: checked,
                      })
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-bg-tertiary rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-text-secondary">
                        Run a quick scan when app starts
                      </p>
                    </div>
                  </div>
                  <Switch
                    checked={scanSettings.scanAtStartup}
                    onCheckedChange={(checked) =>
                      setScanSettings({
                        ...scanSettings,
                        scanAtStartup: checked,
                      })
                    }
                  />
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="text-center py-6">
                  ...
                  <p className="text-text-secondary">
                    Open Source SystemCare Alternative
                  </p>
