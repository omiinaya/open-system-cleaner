  ...
  >([
    {
      ...
      title: "Anti-Tracking",
      description: "Block online tracking and fingerprinting",
      enabled: true,
    },
    {
      id: "anti-phishing",
    ...
    {
      id: "keystroke-encryption",
      icon: <Keyboard className="w-5 h-5" />,
      title: "Keystroke Encryption",
      description: "Encrypt keystrokes to prevent keyloggers",
      enabled: true,
    },
    {
      id: "homepage-protection",
      icon: <Lock className="w-5 h-5" />,
      title: "Homepage Protection",
      description: "Prevent unauthorized browser homepage changes",
      enabled: true,
    },
  ]);
    ...
    <div className="space-y-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-6">
              ...
              <div
                className={cn(
                  ...
                  hardeningScore >= 90
                    ...
                    : hardeningScore >= 70
                      ? "bg-warning-500 shadow-warning-500/20"
            ...
            <div className="flex-1">
              ...
              <p className="text-text-secondary">
                System hardening monitor is{" "}
                {systemHardeningMonitor ? "active" : "disabled"}.{" "}
                {issuesFound > 0
                  ? ` ${issuesFound} security issues found.`
                  : " No issues detected."}
              </p>
            </div>
      ...
      {isScanning && (
        <ScanProgress
          ...
          itemsScanned={Math.floor((scanProgress / 100) * 50000)}
          totalItems={50000}
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <StatCard
          value={systemHardeningMonitor ? "On" : "Off"}
          label="System Hardening Monitor"
          icon={Shield}
          iconColor={systemHardeningMonitor ? "success" : "danger"}
          size="sm"
        />
        <StatCard
          value={`${enabledCount}/${protectionFeatures.length}`}
        ...
        />
        <StatCard
          value={firewallEnabled ? "Active" : "Disabled"}
          label="Firewall"
          icon={Lock}
          iconColor={firewallEnabled ? "success" : "warning"}
          size="sm"
        />
        <StatCard
          ...
          icon={AlertCircle}
          iconColor={issuesFound > 0 ? "danger" : "success"}
          size="sm"
        />
      </div>
          ...
          {!scanComplete && !isScanning ? (
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-text-secondary mt-1">
                      Scan critical areas and running processes
                    </p>
              ...
              <div className="p-4 bg-bg-tertiary rounded-lg border border-border hover:border-primary-500/50 transition-colors">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-text-secondary mt-1">
                      Comprehensive scan of all files and drives
                    </p>
                    <p className="text-xs text-text-tertiary mt-2">
                      ~30-60 minutes
                    </p>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-danger-500/10 border border-danger-200 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-medium text-danger-500">
                      Issues Detected!
                    </h4>
                    <p className="text-sm text-text-secondary mt-1">
                      {issuesFound} security issues were found on your system.
                      We recommend remediating them immediately.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="text-center py-6">
              ...
              <p className="text-text-secondary mt-1">
                Your system is hardened and secure
              </p>
              <Button
                variant="secondary"
                className="mt-4"
            ...
            <div className="flex items-start justify-between">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-text-secondary">
                    Continuously monitor system security and harden
                    configurations
                  </p>
                </div>
              </div>
              <Switch
                checked={systemHardeningMonitor}
                onCheckedChange={setSystemHardeningMonitor}
              />
            </div>
          </CardContent>
        </Card>
