    ...
    (set, get) => ({
      ...
      updateConfig: (newConfig) => {
        ...
        if (newConfig.accentColor) {
          if (typeof document !== 'undefined') {
            document.documentElement.style.setProperty('--accent-primary', newConfig.accentColor);
          }
        }
    ...
    }),
    {
      ...
      onRehydrateStorage: () => (state) => {
        ...
        if (state) {
          ...
          if (typeof document !== 'undefined') {
            // Apply accent color
            document.documentElement.style.setProperty('--accent-primary', state.config.accentColor);
