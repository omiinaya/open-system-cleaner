...
export type SoundType = 'scanComplete' | 'issuesFound' | 'optimizationComplete' | 'success' | 'warning' | 'error';
  ...
  try {
    ...
    switch (type) {
      ...
      case 'optimizationComplete':
        ...
        oscillator.frequency.exponentialRampToValueAtTime(523.25, audioContext.currentTime + 0.15); // C5
        oscillator.frequency.exponentialRampToValueAtTime(659.25, audioContext.currentTime + 0.3); // E5
        oscillator.frequency.exponentialRampToValueAtTime(783.99, audioContext.currentTime + 0.45); // G5
        gainNode.gain.setValueAtTime(0.3, audioContext.currentTime);
